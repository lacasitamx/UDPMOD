...
download_hysteria() {
    ...
    if [ $get_arch = "x86_64" ];then
        wget -q -O /usr/local/bin/hysteria --no-check-certificate https://github.com/lacasitamx/UDPMOD/raw/main/udpmod-amd64
    elif [ $get_arch = "aarch64" ];then
        wget -q -O /usr/local/bin/hysteria --no-check-certificate https://github.com/lacasitamx/UDPMOD/raw/main/udpmod-arm64
    else
